...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Me.realProgress1.Load += New System.EventHandler(AddressOf Me.realProgress1_Load)
            ' 
            ' simpleButton1
            ' 
            ...
            Me.Name = "BusyForm"
            Me.Text = "Busy Form"
            Me.FormClosing += New System.Windows.Forms.FormClosingEventHandler(AddressOf Me.BusyForm_FormClosing)
            Me.ResumeLayout(False)
        End Sub

#End Region
        Private realProgress1 As Busy.ProgressControl
